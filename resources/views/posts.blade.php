                ...
                @foreach ($posts->skip(1) as $post)
                    <div class="col-md-4 mb-3">
                        <div class="card h-100">
                            <div class="position-absolute top-0 px-3 py-1" style="background-color: rgb(0, 0, 0,0.6)">
                                <a href="/posts?category={{ $post->category->slug }}"
                                    class="text-white text-decoration-none fw-bold">{{ $post->category->name }}</a>
                            </div>
                            @if ($post->image)
                            ...
                            <div class="card-footer">
                                <a href="/posts/{{ $post->slug }}" class="btn btn-primary float-end">Read more
                                    &raquo;</a>
                            </div>
                        </div>
                    </div>
